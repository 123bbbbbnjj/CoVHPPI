...
if __name__ == '__main__':
    ...
    for foldn in range(1, 6):
        ...
        my_s = S(test_df, Select_pair_file, Scores_df)
        ppi_test, v_set, h_set = my_s.generate_id_groups()
        my_result_dict = my_s.get_scores_dict(ppi_test, v_set, h_set)
        my_result_df = my_s.get_scores_df(my_result_dict)
