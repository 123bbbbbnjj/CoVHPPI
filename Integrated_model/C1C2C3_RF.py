...
# 1. parameters
output_dir = f"out/preds/RF"  # 设置输出文件夹
output_model_dir = f"out/model_state/RF"
...
for foldn in range(1, 11):
    ...
    model_c1 = RandomForestClassifier(**model_params)
    model_c2h = RandomForestClassifier(**model_params)
    model_c2v = RandomForestClassifier(**model_params)
    model_c3 = RandomForestClassifier(**model_params)
