...
# 1. parameters
output_dir = f"out/preds/SVM"  # 设置输出文件夹
output_model_dir = f"out/model_state/SVM"
...
for foldn in range(1, 11):
    ...
    model_c1 = SVC(**model_params)
    model_c2h = SVC(**model_params)
    model_c2v = SVC(**model_params)
    model_c3 = SVC(**model_params)
